"use client";
import { User, UserCheck, Dog, Users } from "lucide-react";
  ...
  return (
    <>
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        <AggregationCard value={aggregation.loading ? <Spinner size={"medium"}/> : aggregation?.male || 0 } title="ຜູ້ຊາຍ" icon={<Dog color="blue" />} />
