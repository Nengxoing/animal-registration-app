...
// import useCompanyCombobox from "src/app/(protected)/company/company/hook/useCompanyCombobox"; 
import useCompanyCombobox from "src/app/(protected)/company/hook/useCompanyCombobox";
      ...
      >
        ...
        {/* <div className="space-y-4">
          ...
          <Form.Field name="expirationTerm" control={form.control} label="ອາຍຸບັດ" required={false}>
            <Form.Input.Select options={expirationTermOptions} className='w-full' />
          </Form.Field>
          <div className="grid gap-4 sm:grid-cols-2">
...
type ExpirationTerm = "ລິງຫົນແດງ" | "ລິງຫາງຫູ" | "ລິງອັສຊາມ" | "ລິງແຂນຂວາງ" | "ລິງໃບໄມ້ຟາຍ" | "ລິງລາວ" | "ລິງດູກ (ຂາແດງ)" | "ເນາເນາ" | "ເນາເນາ (ເນາ)" | "ເນາເນາ (ເນາ) ຂາແດງ" | "ເນາເນາ (ເນາ) ຂາແນນ";
