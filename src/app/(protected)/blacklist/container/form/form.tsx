    ...
    <Form formInstance={form} onSubmit={onSubmit} className="border-none shadow-none p-0" showButton={false}>
      ...
      <div className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <Form.Field name="name" control={form.control} label="ຊື່ແທ້">
            <Form.Input.Input placeholder="ປ້ອນຊື່"/>
          </Form.Field>
          <Form.Field name="businessCode" control={form.control} label="ເລກທະບຽນ">
            <Form.Input.Input placeholder="ປ້ອນເລກທະບຽນ"/>
          </Form.Field>
          <Form.Field name="businessType" control={form.control} label="ປະເພດບໍລິສັດ">
            <Form.Input.Input placeholder="ປະເພດບໍລິສັດ"/>
          </Form.Field>
