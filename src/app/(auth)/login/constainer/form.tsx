...
export function LoginForm() {
  ...
  return (
    <div className="">
      <Form formInstance={form} onSubmit={onSubmit} showButton={false} className="m-auto flex w-full flex-col justify-center space-y-2 sm:w-[350px] bg-card bg-background rounded-lg">
        <div className="flex flex-col space-y-2 text-left">
          <h1 className="text-2xl justify-center text-center font-semibold tracking-tight font-noto-lao">
            ເຂົ້າລະບົບ
          </h1>
